...
const BasketballFixturesPageContent: React.FC = () => {
  const params = useParams<{ leagueId: string }>();
  const leagueId = params?.leagueId || 12; // Default to NBA if no leagueId is provided
          ...
          const adaptedFixtures: Fixture[] = sortedFixtures.map(
            (game: BasketballGameResponse) => ({
              ...
              league: {
                ...
                season: Number(game.league?.season) || 2024,
...
export default BasketballFixturesPageContent;
