...
const FixturesPageContent: React.FC = () => {
  ...
  const leagueId = params?.leagueId || 71; // Default to Serie A Brazil if no leagueId is provided
    ...
    const fetchFixtures = async () => {
      ...
      try {
        ...
        const response = await fetch(
          `https://v3.football.api-sports.io/fixtures?league=${leagueId}&date=${selectedDate}&season=${currentYear}`,
          {
            method: 'GET',
            headers: {
